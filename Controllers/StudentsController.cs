...
namespace MvcMovie.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,Hoten,Namsinh,GioiTinh,Sodienthoai")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,Hoten,Namsinh,GioiTinh,Sodienthoai")] Student student)
        {
